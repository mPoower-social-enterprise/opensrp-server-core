...
public class HouseholdIdServiceTest extends BaseRepositoryTest {
	...
	public void setUpPostgresRepository() {
		householdIdService = new HouseholdIdService(householdIdRepository, practitionerLocationService);
	}
